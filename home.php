                        ...
                        <div role="main">
                            ...
                            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="tile-stats">
                                    ...
                                    <div class="count"><?php #get_count('id', 'category', ''); ?></div>
                                    <div class="count"><?= get_count('id', 'mfis', ''); ?></div>
                            ...
                            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="tile-stats">
                                    ...
                                    <div class="icon"><em class="fas fa-book">"></em>
                                    </div>
                                    <!-- <div class="count"><?php // get_count('id', 'subcategory'); ?></div> -->
                                    <div class="count"><?= get_count('id', 'subjects'); ?></div>
